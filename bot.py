...
def main():
    ...
    with open('adjectives-tagged.json', 'r+') as out_json:
        adj_data = json.load(out_json)
        # for word in data:
        #     print(data[word][0][0][1])
            ...
            for pos in new_text:
                ...
                if rand_num == 1:
                    ...
                    if pos[1] == "NN" or pos[1] == "NNS":
                        ...
                        continue
                    if pos[1] == "JJ" or pos[1] == "JJS":
                        random_adj = get_random_adj(adj_data, pos)
                        full_tweet = full_tweet.replace(str(pos[0]), str(random_adj), 1)
                        continue
                new_tweet += pos[0] + " "
            try:
